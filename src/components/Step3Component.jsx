      ...
      {!showProperties ? (
        <div className="step3-content">
          ...
          <p className="step3-text">
            ...
            process. It's more than just about the number of rooms or the size
            of the yard. It's about finding a space that resonates with your
            lifestyle and needs. Here are some essential factors to consider in
            your search:
          </p>
          <ul className="step3-list">
            ...
            <li>
              Size: The house should accommodate your family and lifestyle.
              Consider the number of bedrooms and bathrooms, kitchen size, and
              storage space.
            </li>
            <li>
              Future Growth: If you plan on growing your family or hosting
              extended family, consider a home that can cater to this future
              need.
            </li>
            <li>
              Resale Value: Even though you're buying the property to live in,
              it's wise to consider its potential resale value for the future.
            </li>
            <li>
          ...
          <p className="step3-text">
            Take your time when searching for the right house. Attend open
            houses, research online, and don’t rush the process. Work closely
            with your real estate agent who can provide valuable advice and
            assist you in finding a property that suits your preferences and
            needs.
          </p>
